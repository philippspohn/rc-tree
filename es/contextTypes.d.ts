...
export type NodeDragEventHandler<T = HTMLDivElement, TreeDataType extends BasicDataNode = DataNode> = (e: React.MouseEvent<T>, node: NodeInstance<TreeDataType>, outsideTree?: boolean) => void;
